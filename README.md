...
An app for record user's expense - made by [Express](https://expressjs.com/) on [Node.js](https://nodejs.org/en/)
...
* [Mongoose](https://mongoosejs.com/) - version 7.0.2
...
**Filter Expense Record**
* click two select option bar (category and month) below ```新增支出``` button
